            ...
            <div class="recipe__ingredients">
                <div class="recipe__box">
                    ...
                    <div v-for="(ingredient, index) in form.ingredients" class="recipe__form">
                        <input type="text" class="form__control" v-model="ingredient.name" :class="[error[`ingredients.${index}.name`] ? 'error_bg' : '']">
                        <input type="text" class="form__control form__qty" v-model="ingredient.qty" :class="[error[`ingredients.${index}.qty`] ? 'error_bg' : '']">
                        <button class="btn btn__danger" @click="remove('ingredients', index)">x</button>
                    </div>
                ...
                <div class="recipe__directions__inner">
                    ...
                    <div v-for="(direction, index) in form.directions" class="recipe__form">
                        <textarea type="text" class="form__control" v-model="direction.description"
                                  :class="[error[`directions.${index}.description`] ? 'error_bg' : '']"></textarea>
                        <button class="btn btn__danger" @click="remove('directions', index)">x</button>
                    </div>
