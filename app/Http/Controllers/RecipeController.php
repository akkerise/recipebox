...
class RecipeController extends Controller
{
    ...
    public function update($id, Request $request)
    {
        ...
        foreach ($request->ingredients as $ingredient) {
            if (isset($ingredient['id'])) {
                // update
                RecipeIngredient::where('recipe_id', $request->id)->where('id', $ingredient['id'])->update($ingredient);
        ...
        foreach ($request->directions as $direction) {
            if (isset($direction['id'])) {
                // update
                RecipeDirection::where('recipe_id', $request->id)->where('id', $direction['id'])->update($direction);
    ...
    public function destroy($id, Request $request)
    {
        ...
        File::delete(base_path('public/images/' . $recipe->filename));
