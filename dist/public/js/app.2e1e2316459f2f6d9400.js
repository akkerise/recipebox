...
/******/{
    ...
    /* harmony default export */__webpack_exports__["default"] = {
      ...
      methods: {
        register: function register() {
          ...
          this.error = {};
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["a" /* post */])('api/register', this.form).then(function (res) {
            if (res.data.registered) {
              Flash.setSuccess('You have successfully create an Accout!');
  ...
  /******/ });
//# sourceMappingURL=app.2e1e2316459f2f6d9400.js.map